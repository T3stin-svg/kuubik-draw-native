...
P1-01c bounded layout writing/identity/failure checks pass locally; native paperspace
and unsupported-source save protection remain unfinished. Follow `tasks/plan.md`, `docs/ROADMAP.md` and
